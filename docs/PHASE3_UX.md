...
- **Technical Office Engineer, License Department, Egyptian Armed Forces Engineering Authority** (Cairo, Egypt; Jan 2025–Mar 2026, mandatory military service) — ~~inclusion presentation is a pending user decision~~ **RESOLVED 2026-08-24 — EXCLUDED from the EXPERIENCE page entirely: no entry, no identity line, no footnote (DECISIONS #53; explicit user decision scoped to /experience; ABOUT's separate presentation per #49/#51/#52 is unaffected).**
...
5. **Military service presentation.** Whether the Armed Forces Engineering Authority role is a full experience entry or only "Military service completed" is a pending user decision. **RESOLVED 2026-08-23 for ABOUT** — presented on ABOUT as narrative prose (not a timeline entry); (DECISIONS #49; presentation since re-formed by #51 and superseded by #52's narrative-spine beat, PHASE 4C). **RESOLVED 2026-08-24 for EXPERIENCE** — the role is excluded from `/experience` entirely: no timeline entry, no identity line, no footnote (explicit user decision scoped to the EXPERIENCE page; DECISIONS #53). No page carries this question open.
